 ...
 * The same class as ToolMenu2, but for name.
 * @version 1.0
 ...
 */
public class ToolMenu1 extends uk.ac.leeds.mass.fmf.shared_objects.Menu{
	...
	*/
    public ToolMenu1(){
        setMenuName("Inter-tool Comm Template 1");
    }
    ...
    */
    ...
    protected Object[][] getItems(){
        ...
        o[0][0] = "Tool 1"; // Menu item title.
        o[0][1] = new ToolMenu1Listener();
	...
	**/
    class ToolMenu1Listener implements ActionListener{
            ...
            Thread t = new Thread() {
				...
				*/
                ...
                public void run() {
                    ...
                    ToolPanel1 tp = new ToolPanel1(ai);
                    FMFFrame f = ai.getMainPanel("Tool 1 Window Title", tp);
