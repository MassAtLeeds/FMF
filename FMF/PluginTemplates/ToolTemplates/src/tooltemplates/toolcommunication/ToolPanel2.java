 ...
 * This appears when the user selects the "Inter-tool Comm Template 2" menu item. 
 * This template gives the code for allowing the user to drag and drop in a data table.
 * This class is identical to ToolPanel1, save for name.
 * @version 1.0
 ...
 */
public class ToolPanel2 extends JPanel implements DataChangeListener, InternalFrameListener {
